...
class TestKnapsackProblem(unittest.TestCase):
    ...
    def test_getAllValidKnapsackCombinations(self):
        ...
        assertListsEqual(self,
                         knapsack_problem.getAllValidKnapsackCombinations(possible_knapsacks, self.weights,
                                                                          self.capacity),
                         valid_knapsacks)
    ...
    def test_computeKnapsackWeight(self):
        ...
        self.assertEqual(knapsack_problem.computeKnapsackWeight(knapsack, self.weights), 6)
    ...
    def test_findMostValuableKnapsackCombinationsWithSingleMaximumValueKnapsack(self):
        ...
        assertListsEqual(
            self,
            knapsack_problem.findMostValuableKnapsackCombinations([knapsack_1, knapsack_2, highest_value_knapsack],
                                                                  values),
            [highest_value_knapsack])

    def test_findMostValuableKnapsackCombinationsWithMultipleMaximumValueKnapsacks(self):
        knapsack_1 = [0, 1, 2]
        ...
        assertListsEqual(self,
                         knapsack_problem.findMostValuableKnapsackCombinations(
                             [knapsack_1, highest_value_knapsack, highest_value_knapsack_2], values),
    ...
    def test_findLightestKnapsackCombination(self):
        ...
        assertListsEqual(self,
                         knapsack_problem.findLightestKnapsackCombination([knapsack_1, knapsack_2, lightest_knapsack],
                                                                          weights),
                         lightest_knapsack)
    ...
    def test_validateDataWithInvalidValue(self):
        ...
        try:
            ...
            self.assertEqual(validationError.getMessage(),
                             "Data Error: All item values must be greater than or equal to 0.")
    ...
    def test_validateDataWithInvalidWeightCapacity(self):
        ...
        try:
            ...
            self.assertEqual(validationError.getMessage(),
                             "Data Error: The weight capacity must be greater than or equal to 0.")
    ...
    def test_validateDataWithInvalidArrayLengths(self):
        ...
        try:
            ...
            self.assertEqual(validationError.getMessage(),
                             "Data Error: There is an unequal number of weights and values.")
